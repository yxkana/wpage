import { useShowFrontEndSkill } from "~/states/skillStates";
...
export function SkillContainerFrondend() {
    const skillState = useShowFrontEndSkill()
      
    const showImg = useShowFrontEndSkill((state)=> state.setSkill)
        ...
        >
         {/*  eslint-disable-next-line react-hooks/exhaustive-deps */}
          ...
          <div className="flex flex-col gap-10">
            <h1 className="text-3xl font-semibold lg:text-6xl">Frontend</h1>
